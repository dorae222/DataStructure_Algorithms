...
public class PolynomialLinkedListTest {
    ...
    public void testCase03() {
        p2 = new PolynomialLinkedList()
        LOG.info("p2 초기값{}", p2.printPoly());

        p2.addTerm(new TermNode(2, 4)); // 2x+4
        LOG.info("p2 2X^4: {}", p2.printPoly());
    }

    @TEST
    public void testCase04() { // 과제: p1, p2 addPoly testCase04()로 제출     LOG.info("학과,학번,성명"); 출력까지
        p2 = new PolynomialLinkedList()
        LOG.info("p2 초기값{}", p2.printPoly());
